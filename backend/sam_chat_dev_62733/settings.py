"""
Django settings for sam_chat_dev_62733 project.
...
ROOT_URLCONF = 'sam_chat_dev_62733.urls'
...
WSGI_APPLICATION = 'sam_chat_dev_62733.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_chat_dev_62733 API",
    "DESCRIPTION": "API documentation for sam_chat_dev_62733 App",
    "VERSION": "v1",
}
